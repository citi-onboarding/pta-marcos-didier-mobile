                ...
                <div className="w-full">
                    <div className="pt-[40px] w-full ml-[165px]">
                        <div className="flex items-center mr-[100px]">
                            ...
                            <p className="text-[48px] ml-[16px] font-bold">Cadastro</p>
                        </div>
                    </div>

                    <div className="w-[1532px] ml-[165px] mt-[40px] overflow-y-auto">
                        <form onSubmit={handleSubmit(submitForm)} className="flex flex-col gap-y-6">
                            <div className="grid grid-cols-2 gap-6 w-full">
                                <div className="flex flex-col gap-2">
                                <span className="font-bold text-gray-900 text-lg">Nome do paciente</span>
                                <input
                                    {...register("Nome do Paciente", { required: true })}
                                    placeholder="Digite aqui..."
                                    className="border border-gray-400 rounded-lg px-4 py-3 w-full placeholder:text-gray-300 text-gray-700 focus:outline-none focus:border-black focus:ring-1 focus:ring-black transition-colors text-lg"
                                />
                                </div>
                                <div className="flex flex-col gap-2">
                                <span className="font-bold text-gray-900 text-lg">Nome do tutor</span>
                                <input
                            ...
                            <span className="font-bold text-gray-900 text-lg">Qual é a espécie do paciente?</span>
                            ...
                            <div className="grid grid-cols-2 gap-6 w-full">
                            <div className="flex flex-col gap-2">
                                <span className="font-bold text-gray-900 text-lg">Idade do paciente</span>
                                <input
                                    type="number"
                                    min="0"
                            ...
                            <div className="flex flex-col gap-2">
                                <span className="font-bold text-gray-900 text-lg">Tipo de consulta</span>
                                <select
                                    {...register("Tipo de consulta", { required: true })}
                                    defaultValue=""
                                    className="border border-gray-400 rounded-lg px-4 py-3 w-full text-gray-700 focus:outline-none focus:border-black focus:ring-1 focus:ring-black transition-colors bg-white text-lg"
                                >
                            ...
                            <div className="flex flex-col gap-2">
                                <span className="font-bold text-gray-900 text-lg">Médico responsável</span>
                                <select
                            ...
                            <div className="flex flex-col gap-2">
                                <span className="font-bold text-gray-900 text-lg">Data do atendimento</span>
                                <input
                                    type="date"
                                    min={new Date().toISOString().split("T")[0]}
                                    {...register("Data do atendimento", {required: true})}
                                    className="border border-gray-400 rounded-lg px-4 py-3 w-full text-gray-700 focus:outline-none focus:border-black focus:ring-1 focus:ring-black transition-colors text-lg"
                                />
                            </div>
                            <div className="flex flex-col gap-2">
                                <span className="font-bold text-gray-900 text-lg">Horário do atendimento</span>
                                <input 
                                    type="time"
                            ...
                            <span className="font-bold text-gray-900 text-lg">Descrição do problema</span>
                            <textarea
                                {...register("Descrição do problema", {required: true})}
                                placeholder="Descrição do problema"
                                rows={4}
                                className="border border-gray-400 rounded-lg px-4 py-3 w-full placeholder:text-gray-300 text-gray-700 focus:outline-none focus:border-black focus:ring-1 focus:ring-black transition-colors resize-none text-lg"
                            />
                            </div>
                            ...
                            <div className="flex justify-end w-full mt-8">
                                <button
                                    type="submit"
                                    className="bg-[#50E678] text-white font-bold py-3 px-8 rounded-full hover:brightness-90 transition-all shadow-md text-lg"
                                >
                                    Finalizar Cadastro
                                </button>
                            </div>
