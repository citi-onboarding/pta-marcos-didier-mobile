...
export default function Atendimento() {
  ...
  return (
    <div className="flex flex-1 flex-col bg-[#FFFFFF]">
      ...
      <div className="ml-[194px] mt-[48px] flex items-center">
        <Image src={Arrow} alt="arrow back" />
        <p className="text-[48px] font-bold ml-[16px]">Atendimento</p>
      </div>

      <div className="w-[660px] h-[100px] ml-[194px] mt-[32px] bg-[#FFFFFF]">
        ...
        <div className="w-[660px] h-[50px] mt-[24px] items-center flex">
          ...
          <div className="w-[116px] h-[42px] ml-[24px] bg-[#7D1AD7] rounded-full ">
            <button className="w-[116px] h-[42px] text-white font-semibold rounded-full hover:brightness-90 transition-all">
              <span>Buscar</span>
            </button>
          </div>
        </div>
      ...
      <div className="w-[1,532px] h-[62px] mt-[40px] ml-[194px] mr-[194px] bg-[#FFFFFF] flex">
        <div className="w-[243px] h-[62px] bg-[#F0F0F0] flex items-center justify-center">
          <button
            onClick={() => setSelectedTab("agendamento")}
            className={`w-[159px] h-[49px] rounded-[8px] ml-[8px] ${
          ...
          <button
            ...
            className={`w-[92px] h-[42px] mr-[8px] rounded-[8px] ${
        ...
        <div className="ml-[1009px]">
          <Popover open={open} onOpenChange={setOpen}>
            <PopoverTrigger asChild>
              <Button
                variant="outline"
                id="date"
                className="w-[126px] h-[56px] justify-between font-normal"
              >
                {date
      ...
      <div className="grid grid-cols-3 ml-[194px] gap-3 mt-2 w-[1532px] h-[294px] overflow-y-auto">
      ...
      <div className="w-[205px] h-[48px] ml-[1560px] mt-[60px]">
        <Botao text="Nova Consulta" color="#50E678" image_src="/Vector.svg" />
      </div>
    </div>
  );
}
